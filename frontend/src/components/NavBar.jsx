...
export default function NavBar() {
  ...
  <nav>
    <div className={`max-w-screen  container m-auto h-20  md:px-20 px-6 fixed top-0 right-0 left-0 z-50  ${sticky?"shadow-md bg-gray-400 duration-300 transition-all ease-in-out":"bg-white"}`}>
